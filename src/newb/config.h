...
#define NL_NIGHT_SUN_COL   vec3(0.3,0.64,1.00)
...
/* Torch colors */
#define NL_OVERWORLD_TORCH_COL  vec3(1.24,0.56,0.7)
#define NL_UNDERWATER_TORCH_COL vec3(.7,0.7,0.7)
#define NL_NETHER_TORCH_COL     vec3(1.24,0.52,0.7)
#define NL_END_TORCH_COL        vec3(1.0,0.02,1.0)
...
#define NL_DAY_ZENITH_COL    vec3(0.45,0.53,0.69)
#define NL_DAY_HORIZON_COL   vec3(0.52,0.61,0.81)
#define NL_NIGHT_ZENITH_COL  vec3(0.03,0.01,0.24)
#define NL_NIGHT_HORIZON_COL vec3(0.15,0.13,0.34)
...
#define NL_DAWN_ZENITH_COL   vec3(2.0,0.5,0.1)
...
/* Ore glow intensity */
#define NL_GLOW_TEX 4.18    // 0.4 weak ~ 8.0 bright
...
#ifdef BOX_CLOUDS_AND_CHUNK_ANIM
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 0
  #define NL_CHUNK_LOAD_ANIM 100.0
  #undef NL_WATER_CLOUD_REFLECTION
...
#ifdef ROUNDED_CLOUDS_AND_CHUNK_ANIM
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 2
  #define NL_CHUNK_LOAD_ANIM 100.0
#endif

#ifdef DOUBLE_BOX_CLOUDS_AND_CHUNK_ANIM
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 0
  #define NL_CHUNK_LOAD_ANIM 100.0
...
#ifdef DOUBLE_ROUNDED_CLOUDS_AND_CHUNK_ANIM
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 2
  #define NL_CHUNK_LOAD_ANIM 100.0
...
#ifdef ROUNDED_CLOUDS_NO_PLANT_WAVES
  #undef NL_CLOUD_TYPE
  #define NL_CLOUD_TYPE 2
  #undef NL_PLANTS_WAVE
#endif
