...
#define NL_TORCH_INTENSITY 1.3  // 0.5 weak ~ 3.0 bright
...
#define NL_DAY_HORIZON_COL   vec3(0.85,0.91,0.99)
...
#define NL_END_ZENITH_COL    vec3(0.07,0.00,0.45)
#define NL_END_HORIZON_COL   vec3(0.15,0.08,0.62)
#define NL_DAWN_ZENITH_COL   vec3(2.0,0.6,0.1)
#define NL_DAWN_HORIZON_COL  vec3(2.0,0.7,0.0)
#define NL_DAWN_EDGE_COL     vec3(2.0,0.5,0.2)
...
#define NL_WATER_TINT vec3(0.1,0.6,0.7)
...
#define NL_UNDERWATER_TINT vec3(0.1,0.6,0.7) // fog tint color when underwater

/* Cloud type */
#define NL_CLOUD_TYPE 1 // 0:vanilla, 1:soft, 2:rounded

/* Vanilla cloud settings - make sure to remove clouds.png when using this */
#define NL_CLOUD0_THICKNESS 3.5      // 0.5 slim ~ 8.0 fat
#define NL_CLOUD0_RAIN_THICKNESS 4.2 // 0.5 slim ~ 8.0 fat
...
#define NL_CLOUD1_OPACITY 0.4              // 0.0 invisible ~ 1.0 opaque
...
#define NL_CLOUD2_SHAPE 0.3                // 0.0 round ~ 1.0 box
...
#define NL_CLOUD2_LAYER2_THICKNESS 2.6            // 0.5 slim ~ 5.0 fat
...
#define NL_CLOUD2_LAYER2_SHAPE 0.3                // 0.0 round ~ 1.0 box
...
#define NL_AURORA_COL1 vec3(0.01,0.08,0.66)
#define NL_AURORA_COL2 vec3(0.22,0.01,0.66)
...
#define NL_SUNMOON_SIZE 0.73     // 0.3 tiny ~ 4.0 massive
...
#define NL_ENTITY_EDGE_HIGHLIGHT 0.40 // 0.0 no highlight ~ 1.6 bright highlight
