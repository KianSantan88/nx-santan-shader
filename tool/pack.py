...
def run(args):
    ...
    if profile == 'android':
        patch_warning += "MB loader or Patched Minecraft"
    elif profile == 'windows':
        patch_warning += "BetterRenderDragon and Matject"
    elif profile == 'merged':
        patch_warning += "BetterRenderDragon and Matject or Patched Minecraft"
    else:  # ios
